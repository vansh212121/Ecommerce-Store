...
@router.post(
    ...
    response_model=TokenResponse,
    summary="Login for Access Token",
    description="Authenticate with email and password to receive JWT tokens.(Admin Only)",
    dependencies=[Depends(rate_limit_auth)],
)
async def admin_login(
    *,
    ...
    """
    Standard user login. The 'username' field of the form should contain the user's email. (Admin Only)
    """
    client_ip = request.client.host if request.client else "unknown"
